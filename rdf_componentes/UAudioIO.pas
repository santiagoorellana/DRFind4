...
uses
  Windows, Messages, Classes, SysUtils, mmSystem, UAudioUtiles;
...
type
  ...
  protected
    ...
    class function GetNumDevs: DWORD; virtual; abstract;
...
begin
  ...
  begin
    fOnLevel(Self, GetWaveAudioPeakLevel(Buffer, BufferSize, WaveFormat.wBitsPerSample));
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      while Opening do
        WaitForSyncObject(GetCurrentThread, 0);
    end;
  end;
end;
